...
interface Window {
  api: {
    ...
    getYearlyKpiReps(token: string, year: number, branchIds?: number[]): Promise<import('./types').YearlyKpiRepRow[]>
    getYearlyKpiTeams(token: string, year: number, branchIds?: number[]): Promise<import('./types').YearlyKpiTeamRow[]>
